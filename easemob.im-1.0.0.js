  ...
  (function($) {
    ...
    connection.prototype.sendVideo = function(options) {
      ...
      var myonComplete = function(data) {
        ...
        options["uuid"] = data.entities[0].uuid;
        options["length"] = data.duration || 0;
        conn.sendVideoMessage(options);
      };
      options.appName = this.context.appName || '';
      options.orgName = this.context.orgName || '';
      options.accessToken = this.context.accessToken || '';
    ...
    connection.prototype.setPresenceForGroup = function(roomId) { //every group should call this func only once before you can send any message to groups.
      ...
      dom.c("x").node.setAttribute("xmlns", "http://jabber.org/protocol/muc");
      dom.up().c("join").node.setAttribute("xmlns", "http://jabber.org/protocol/muc");
      this.sendCommand(dom.tree());
    };
    ...
    if (typeof Easemob.im.Helper == 'undefined') {
      ...
      Easemob.im.Helper.parseTextMessageRaw = parseTextMessageRawFn;
